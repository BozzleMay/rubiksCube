...
const ButtonControls = ({handleClick, toggleSwitch}) => {
    ...
    <Paper elevation={3} sx={{width:350}} >
       ...
       <div className='leftSide'>
        <div>
                <Button variant='contained' className='direction_button' size='small' onClick={() => handleClick('frontClockwise')}>Front Clockwise</Button>
            </div>
            <div>
        ...
        <div className='rightSide'>
            <div>
                <Button variant='contained' className='direction_button'  size='small' onClick={() => handleClick('frontInverted')}>Front Inverted</Button>
            </div>
            <div>
