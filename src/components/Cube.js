...
// const styles = {
//     cubeStyle:{ animation: 'turn 20s linear infinite'}
// }
...
const Cube = () => {
    ...
    switch(direction) {
        case 'leftClockwise':
            ...
            console.log(front, back, right, top, left, bottom)
             break;  
             case 'leftInverted':
        ...
        case 'rightInverted':
            ...
            console.log(top, left, right, bottom, back, front)
             break;
             case 'rightClockwise':
